...
def main(args):
    ...
    if args.only_dump_feat:
        max_norm = torch.load(os.path.join(os.path.dirname(args.index_path), 'wd_max_norm.pt'))
        ...
        torch.save(torch.from_numpy(used_data), os.path.join(os.path.dirname(args.index_path), 'wd_feat.pt'))
        exit(0)
    ...
    if args.train_index:
        ...
        torch.save(max_norm, os.path.join(os.path.dirname(args.index_path), 'wd_max_norm.pt'))
    else:
